...
export const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-background border-t border-border">
      <div className="container py-3 md:py-4 flex items-center justify-center gap-2 text-sm">
        <Link
        ...
        <Link
          href="https://www.vizlook.com/dashboard/api-keys"
